...
#the linear model fits the data a lot better here, R^2= 0.3174, year explains about 32% of the variability in data. 
...
>>>>>>> 2682200dc9ffee34998ef1fce148f1bb035e26c7
```
...
mean_unique_words_ratio <-mean(unique_words_ratios$ratio)
mean_unique_words_ratio

rap_ratio <-generate_unique_ratios(LyricsTopRapSongs3)

# create graph showing how the unique ratio has changed over time:
unique_ratio_graph_by_year <-
  ggplot(unique_words_ratios, aes(x = Year, y = ratio)) +
  geom_line() +
...
unique_ratio_graph_by_year <- unique_ratio_graph_by_year + geom_hline(yintercept = mean_unique_words_ratio, color = "skyblue3")
unique_ratio_graph_by_year

ggplot(rap_ratio, aes(x = Year, y = ratio)) +
  geom_line() +
  labs(title = "Unique Words Ratio Over Time",
       x = "Year",
       y = "Unique Words Ratio") +
