...
songs_for_azlyrics <- as.data.frame(sapply(TopSongs, function(x) tolower(gsub("\\s+", "", x))))
...
# running into an error because some artists have "the" in front of their names in the data frame and not in the url for azlyrics.com. It stops at the 5th iteration because of the song all i have to do is dream by everly brothers, because the link is "https://www.azlyrics.com/lyrics/everlybrothers/allihavetodoisdream.html". The data frame songs_for_azlyrics has the artist as theeverlybrothers. Need to fix
