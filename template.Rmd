...
generate_unique_ratios <- function(song_df) {
  ...
  overall_unique_words_ratio <- mean(unique_words_by_year$ratio)
  
  return(overall_unique_words_ratio)
  return(unique_words_by_year)
}

unique_words_ratio<- generate_unique_ratios(TopCountry)
unique_words_ratio
...
#   theme_minimal()
# 
# unique_ratio_graph_by_year + geom_hline(yintercept = overall_unique_words_ratio)
