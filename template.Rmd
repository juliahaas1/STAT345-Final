...
#Look at years 1958 through 1968
decade1 <- TopCountry$Year >= 1958 & TopCountry$Year <= 1968
decade1data <- TopCountry[decade1, ]
...
corpus <- Corpus(VectorSource(decade1data$lyrics))
corpus <- tm_map(corpus, removeWords, stopwords("english"))

result %>% top_n(20, Frequency)
```
